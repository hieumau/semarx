...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {
                path: 'event',
                loadChildren: () => import('app/modules/feature/events/events.module').then(m => m.EventsModule)
            },
            {
                path: 'feature-group',
                loadChildren: () => import('app/modules/feature/feature-group/feature-group.module').then(m => m.FeatureGroupModule)
            },
            {
                path: 'feature',
                loadChildren: () => import('app/modules/feature/feature/feature.module').then(m => m.FeatureModule)
            },
            {
                path: 'default-config',
                loadChildren: () => import('app/modules/feature/default-config/default-config.module').then(m => m.DefaultConfigModule)
            },
            {
                path: 'object',
                loadChildren: () => import('app/modules/feature/object/object.module').then(m => m.ObjectModule)
            },
        ]
    }
];
